    ...
    <div>
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-3">
          ...
          <h3 className="text-2xl font-bold">Contact & Business Info</h3>
        </div>
        <p className="text-gray-400">Tell us about yourself and your business.</p>
      </div>

      <div className="grid sm:grid-cols-2 gap-5">
        {/* Contact fields first */}
        <motion.div variants={item} initial="hidden" animate="show" custom={0} className="sm:col-span-2">
          ...
          <input
            ...
            className={`${inputClasses} ${errors.contactName ? 'border-red-400/50' : ''}`}
        ...
        <motion.div variants={item} initial="hidden" animate="show" custom={1}>
          <label className={labelClasses}>
            <span className="flex items-center gap-1.5"><Mail className="w-3.5 h-3.5" /> Email <span className="text-red-400">*</span></span>
          </label>
          <input
            type="email"
            placeholder="you@company.com"
            className={`${inputClasses} ${errors.contactEmail ? 'border-red-400/50' : ''}`}
        ...
        {/* Divider */}
        <motion.div variants={item} initial="hidden" animate="show" custom={3} className="sm:col-span-2 border-t border-dark-border pt-5 mt-1">
          <label className={labelClasses}>
        ...
        <motion.div variants={item} initial="hidden" animate="show" custom={6} className="sm:col-span-2">
          <label className={labelClasses}>
